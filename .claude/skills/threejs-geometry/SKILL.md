...
// Share the base geometry's buffers. Don't use geometry.copy(base): it copies
// base.instanceCount, which is undefined on a plain geometry, and nothing draws.
...
// Compute tangents (required for normal maps). A BufferGeometry method;
// needs an index, normals and uvs
