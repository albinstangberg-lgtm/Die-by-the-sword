...
npm run smoke    # headless physics harness — 405 checks, no browser needed
...
## Sixty-six things the physics taught us
...
and `Ai` against Rapier in Node — no WebGL, no browser, 405 checks in a few
